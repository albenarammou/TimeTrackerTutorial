...
namespace TimeTrackerTutorial.PageModels
{
    public class DashboardPageModel : PageModelBase
    {
        ...
        public DashboardPageModel(ProfilePageModel profilePM, SettingsPageModel settingsPM, SummaryPageModel summaryPM, TimeClockPageModel timePM)
        {
            ProfilePageModel = _profilePM;
            SettingsPageModel = _settingsPM;
            SummaryPageModel = _summaryPM;
            TimeClockPageModel = _timePM;
        }
